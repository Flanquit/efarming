...
@endphp
@extends('layouts.app', ['activePage' => 'home', 'title' => __('Material Dashboard')])
                ...
                <div class="main_content  ">
                    ...
                    <div id="shopify-section-1592481403120"
                        ...
                        <div
                            ...
                            <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                                ...
                                <div class="swiper-slide image_slide swiper-slide-active" style="width: 800px;">

                                    <img style="width: 100%" class="slideshow_image blur-up lazyloaded"
                                         src="{{asset('images/Done/bannerheader2.png')}}"
                                         alt="" data-srcset="{{asset('images/Done/bannerheader2.png?v=1592482668 1300w')}},
							//{{asset('images/Done/bannerheader2.png?v=1592482668 1200w')}}?v=1592482668 1200w,
							//{{asset('images/Done/bannerheader2.png?v=1592482668 1200w')}}?v=1592482668 1200w,
							//{{asset('images/Done/bannerheader2.png?v=1592482668 720w')}}?v=1592482668 720w,
							//{{asset('images/Done/bannerheader2.png?v=1592482668 540w')}}?v=1592482668 540w
							" srcset="//{{asset('images/Done/bannerheader2.png?v=1592482668 1200w')}}?v=1592482668 1300w,
							//{{asset('images/Done/bannerheader2.png?v=1592482668 1200w')}}?v=1592482668 1200w,
							//{{asset('images/Done/bannerheader2.png?v=1592482668 1200w')}}v=1592482668 960w,
							//{{asset('images/Done/bannerheader2.png?v=1592482668 1200w')}}?v=1592482668 720w,
							//{{asset('images/Done/bannerheader2.png?v=1592482668 1200w')}}?v=1592482668 540w
							">
                                    ...
                                    <div class="slide_caption position_left">
                                        ...
                                        <div class="container ">
                                            <p class="slide_caption__subheader"></p>
                                            <h2><p>organic</p>
                                                <p>products</p></h2>

                                            <a class="btn slider_btn" href="{{route('catalogue')}}">View More</a>
                    ...
                    <div id="shopify-section-1575280519933"
                        ...
                        <div class="collection_listing_wrap container">
                            ...
                            <h4 class="section_heading" style="color: white;font-size: 30px;">Popular categories</h4>
                            ...
                            <div class="row collection_listing__main collection_listing_size_boxed">
                                    ...
                                    <a class="collection_item" href="{{route('collections')}}">
                                        <div class="collection_img">
                                            ...
                                            <img style="width: 100%" class="blur-up lazyloaded"
                                                 ...
                                                 data-src="{{asset('images/nyevhe.jpeg?v=1592465575')}}"
                                                 alt="Beans">
                                        ...
                                        <div class="collection_caption">
                                            <div>
                                                ...
                                                <?php $beans = Farmer::where('product', 'maize')->get(); ?>

                                                    @foreach ($beans as $item)
                                                    
                                                    <p style="font-size:15px;color:0000;">Farmer : {{$item->name}}}
                                                    Contacts : {{$item->phone}}}
                                ...
                                <div class="col-sm-3 type_1">
                                    ...
                                    <a class="collection_item" href="{{route('carrots')}}">
                                        <div class="collection_img">
                                        ...
                                        <div class="collection_caption">
                                            <div>
                                                ...
                                                <?php $Carrots = Farmer::where('product', 'carrots')->get(); ?>

                                                @foreach ($Carrots as $item)
                                ...
                                <div class="col-sm-3 type_1">
                                    ...
                                    <a class="collection_item" href="{{route('groundnuts')}}">
                                        <div class="collection_img">
                                        ...
                                        <div class="collection_caption">
                                            <div>
                                                ...
                                                <?php $groundNuts = Farmer::where('product', 'groundnuts')->get(); ?>

                                                @foreach ($groundNuts as $item)
                                ...
                                <div class="col-sm-3 type_1">
                                    ...
                                    <a class="collection_item" href="{{route('potatoes')}}">
                                        <div class="collection_img">
                                        ...
                                        <div class="collection_caption">
                                            <div>
                                                ...
                                                <?php $Potatoes = Farmer::where('product', 'Potatoes')->get(); ?>

                                                @foreach ($Potatoes as $item)
                        ...
                        <div class="container layout_boxed">
                            ...
                            <div class="banner_item">
                                ...
                                <div class="img_placeholder__wrap img_placeholder__large"
                                     style="background-image: url({{asset('images/Done/beans.png')}}?v=1592484350 );"></div>


                                <a class="caption_text" href="{{route('collections')}}">

                                    <div class="text"><p>Maputi</p></div>
                            ...
                            <div class="banner_item">
                                ...
                                <div class="img_placeholder__wrap img_placeholder__large"
                                     style="background-image: url({{asset('images/Done/tomatoes.png')}}?v=1592484471 );"></div>


                                <a class="caption_text" href="{{route('collections')}}">

                                    <div class="text"><p>Fresh berries</p></div>
                            ...
                            <div class="banner_item">
                                ...
                                <div class="img_placeholder__wrap img_placeholder__large"
                                     style="background-image: url({{asset('images/Done/carots.png')}}?v=1592484575 );"></div>


                                <a class="caption_text" href="{{route('collections')}}">

                                    <div class="text"><p>Grains &amp; pasta</p></div>
