                ...
                <div class="main_content  ">
                    ...
                    <div class="container layout_boxed">
                        ...
                        <div class="banner_item">
                            <h5>Tomatoes </h5>
                            <img src="{{asset('images/Done/tomatoes.png')}}" alt="">
                           <p>
                                ...
                                <div class="col-sm-3 type_1">
                                    ...
                                    <a class="collection_item" href="#">
                                        <div class="collection_img">
                                            ...
                                            <img style="width: 100%" class="blur-up lazyloaded"
                                                 src="{{asset('images/meat.jpg')}}"
                                                 data-src="{{asset('images/Done/meat.png')}}"
                                                 alt="Beef">
                                        ...
                                        <div class="collection_caption">
                                            <div>
                                                <h5 class="collection_title">Beef</h5>
                                            </div>@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'home', 'title' => __('Material Dashboard')])
