                ...
                <div class="main_content  ">
                    ...
                    <div class="container layout_boxed">
                        ...
                        <div class="banner_item">
                            <h5>Ground Nuts</h5>
                            <img src="{{asset('images/Done/groundNuts.png')}}" alt="">
                           <p>
                            Nuts contain the diverse nutrients that are needed for the growth of a new plant.[3] Composition varies, but they tend to have a low water and carbohydrate content, with high levels of fats, protein, dietary minerals, and vitamins.[3] The digestibility of the protein at about 90% is slightly lower than that of meat and fish, but can be improved by thorough chewing.[11] The fats are largely unsaturated and nuts are a source of essential omega-3 fatty acids.[3][12] As part of a healthy human diet, long-term consumption of diverse nutrients in nuts may contribute to a lower risk of cardiovascular diseases, reduced levels of blood cholesterol, and lower all-cause mortality.[3] For vegetarians and vegans, nuts provide many of the essential nutrients which may be in short supply in other plant foods</p>
                        </div>
                        ...
                        <div class="collection_listing_wrap container">
                            ...
                            <div class="row collection_listing__main collection_listing_size_boxed">
                                    ...
                                    <a class="collection_item" href="#">
                                        <div class="collection_img">
                                            ...
                                            <img style="width: 100%" class="blur-up lazyloaded"
                                                 src="{{asset('images/Done/dovi.png')}}"
                                                 data-src="{{asset('images/Done/dovi.png')}}"
                                                 alt="Dovi">
                                        ...
                                        <div class="collection_caption">
                                            <div>
                                                <h5 class="collection_title">Dovi</h5>
                                ...
                                <div class="col-sm-3 type_1">
                                    ...
                                    <a class="collection_item" href="{{route('welcome')}}">
                                        <div class="collection_img">

                                            <img style="width: 100%" class="blur-up lazyloaded"
                                                 src="{{asset('images/Done/maputi.png')}}"
                                                 data-src="/{{asset('images/Done/maputi.png')}}"
                                                 alt="Maputi">
                                        ...
                                        <div class="collection_caption">
                                            <div>
                                                <h5 class="collection_title">Maputi</h5>
                                            </div>
                                        </div>
                                    </a>
                                </div>
